...
model = load_model(r'C:\Users\ASUS\Desktop\ML\gugelnet.h5')
...
st.title("Prediksi Kematangan Buah Naga - 1615")
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                for i, class_name in enumerate(["Matang", "Mentah"]):
